      ...
      <div className="row">
        ...
        <div className="col s2">
          ...
          <ul id="searchCriteria" className="dropdown-content">
            <li><a href="#N" className="black-link center-align" onClick={() => this.changeFilter('Namespace')}>Namespace</a></li>
            <li><a href="#K" className="black-link center-align" onClick={() => this.changeFilter('Key')}>Key</a></li>
          </ul>
        </div>
      </div>
    );
